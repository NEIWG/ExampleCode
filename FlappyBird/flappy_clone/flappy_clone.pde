//EMG Controlled Flappy Bird Clone
//Modified from https://www.openprocessing.org/sketch/136753 by Brian B. Terry (brianbterry@gmail.com) and Oguz Yetkin (oyetkin@gmail.com)
//demo for EMGDuino board for the Neural Electric Interface Group



/* @pjs font="04b_19.TTF"; 
preload="background.png, bird.png, bottomtube.png, ground.png, toptube.png"; 
 */
...
float toptubeY;
float gravity;
final float gap = 125; // size of tube gap
